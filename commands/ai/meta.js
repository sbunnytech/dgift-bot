...
export const alias = ['metaai', 'llama']
export const category = 'AI'
export const desc = 'Chat with Meta AI'

export default async function meta(sock, { msg, from }, botSettings) {
  try {
    ...
    if (!prompt) {
      return sock.sendMessage(from, { text: '❌ Usage:.meta hello' }, { quoted: msg })
    }
    ...
    const systemPrompt = `You are Meta AI, a smart AI assistant created by Meta.
...
4. You are Meta AI, created by Meta.
5. If asked who made you: "Meta"
