...
export const alias = ['ds', 'deep']
export const category = 'AI'
export const desc = 'Chat with DeepSeek'

export default async function deepseek(sock, { msg, from }, botSettings) {
  try {
    ...
    if (!prompt) {
      return sock.sendMessage(from, { text: '❌ Usage:.deepseek hello' }, { quoted: msg })
    }
    ...
    const systemPrompt = `You are DeepSeek, a smart AI assistant created by DeepSeek AI.

Rules:
1. Answer in the user's language. Match exactly.
2. Keep replies short, 2-3 lines max unless user asks for details.
3. Be direct, logical, and helpful.
4. You are DeepSeek, created by DeepSeek AI.
5. If asked who made you: "DeepSeek AI"
